...
// This will insert comprehensive sample data for testing

use tapaal

print("🗄️ Inserting comprehensive sample data...");

// Clear existing data (optional - comment out if you want to keep existing data)
db.inwardmails.deleteMany({});
db.outwardmails.deleteMany({});

print("📤 Inserting Inward Mails...");
...
print("🚀 Your Tapaal application now has comprehensive test data!");
