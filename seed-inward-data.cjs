...
const inwardMailsData = [
    ...
    {
        mailId: 'INW-825',
        subject: 'संघटनेने आयोजित केलेल्या आंदोलनात सहभागी होणेकरी ता अर्जित रजेचा नमुना',
        sender: 'Revenue Department',
        senderName: 'Revenue Department',
        priority: 'Normal',
        status: 'closed',
    ...
    {
        mailId: 'INW-818',
        subject: 'अंकिता विलास लाड साहेब गटविकास अधिकारी पंचायत समिती अमरावती यांचा विषय संघटनेने आयोजित केलेल्या आंदोलनात सहभागी होणेकरी ता अर्जित रजेचा नमुना',
        sender: 'Revenue Department',
        senderName: 'Revenue Department',
        priority: 'Normal',
        status: 'closed',
...
async function seedInwardMails() {
    try {
        console.log('🌱 Starting to seed inward mails data...');
        ...
        console.log('🎉 Inward mails data seeded successfully!');

        // Show summary
        const totalMails = await prisma.inwardMail.count();
        console.log(`📊 Total inward mails in database: ${totalMails}`);
