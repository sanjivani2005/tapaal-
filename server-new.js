...
async function startServer() {
    ...
    const mailRoutes = await import('./src/api/mails.mjs');
    const departmentRoutes = await import('./src/api/departments.mjs');
    const { addInwardMails } = await import('./add-inward-data.mjs');
    ...
    // API Routes
    app.use('/api/mails', mailRoutes.default);
    ...
    app.listen(PORT, () => {
        ...
        console.log(`➕ Add Inward Data: http://localhost:${PORT}/api/add-inward-data`);
    });
}
